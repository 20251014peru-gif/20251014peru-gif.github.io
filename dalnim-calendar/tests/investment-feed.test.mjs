import test from 'node:test';import assert from 'node:assert/strict';import {mapRecordToEvent,mapCheckToEvent,mapReviewToEvent} from '../server/investment-feed.mjs';
